...
<div class="container">
 ...
 <div class="card-header"> <h4 class="pull-left"> <?php echo e(__('msg.StartYourExam')); ?></h4> <a class="pull-right btn btn-info btn-lg" href="<?php echo e(url('/start-now')); ?>"><?php echo e(__('msg.Startbtn')); ?></a></div>
...
<div class="  " dir="rtl" style="<?php echo e(__('msg.inlineStyleArabic')); ?>">
...
<div>  <a class="pull-right btn btn-info btn-lg" href="<?php echo e(url('/start-now')); ?>"><?php echo e(__('msg.Startbtn')); ?></a></div>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Xampp\htdocs\Mafaz\Mafaz\resources\views/main-after-login.blade.php ENDPATH**/ ?>